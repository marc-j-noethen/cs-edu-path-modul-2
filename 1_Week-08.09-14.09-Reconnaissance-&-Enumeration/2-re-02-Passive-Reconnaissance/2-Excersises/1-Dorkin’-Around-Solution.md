...
**Course:** Cyber Security Analyst - Passive Reconnaissance | **Date:** 09 September 2025
...
**Goal:**  
Refine your Google Dorking skills to find specific public information about a large company and understand the strategic value of different dork constructions.

**Requirements:**

- **Official Documents:** Find PDF documents hosted on `uber.com`. Note one public document of your choice. What type of information does this dork target?
    
- **Engineering Insights:** Locate articles on `uber.com` discussing "security" within their "engineering" context. List one title. What insights can this provide?
    
- **Public Tech Talks:** Find presentations (e.g., PPT, PDF on sites like SlideShare) about Uber's technology or projects. Name one. Why are such presentations useful?
    
- **API Chatter:** Discover discussions about Uber's API on developer communities (e.g., Stack Overflow, GitHub). What technical details might these reveal?
...
objective = 'Refine your Google Dorking skills to find specific public information about a large company and understand the strategic value of different dork constructions.'
evidence = 'Submit a document containing:'
...
```text
I completed the referenced lab for "Dorkin’-Around" and captured the requested evidence.
```
