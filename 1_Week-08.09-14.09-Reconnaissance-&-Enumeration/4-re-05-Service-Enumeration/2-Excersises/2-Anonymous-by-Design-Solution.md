...
**Goal:**  
Understand how anonymous FTP access vulnerabilities are created by configuring and exploiting your own FTP server.

**Requirements:**

- **Become the Admin:**
    
- Install the `vsftpd` FTP server on your Kali
    
- After installation, research and modify its configuration file to allow for anonymous user logins.
...
objective = 'Understand how anonymous FTP access vulnerabilities are created by configuring and exploiting your own FTP server.'
evidence = 'Submit screenshot showing successful banner grab, and anonymous connection'
...
```text
I answered the required sub-tasks for "Anonymous-by-Design" and submitted the requested format.
```
