...
**Course:** Cyber Security Analyst - Service Enumeration | **Date:** 11 September 2025
...
**Goal:**  
Perform content discovery against a live web application to identify non-public directories or pages.

**Requirements:**

- The website `http://testphp.vulnweb.com` is a public application designed for security testing.
    
- Use a directory enumeration tool and a common wordlist to discover interesting endpoints on the server.
    
- A popular, already installed tool in Kali is `gobuster`
    
- Kali comes with some wordlists, this one will do the trick `/usr/share/wordlists/dirb/common.txt`
...
objective = 'Perform content discovery against a live web application to identify non-public directories or pages.'
evidence = 'Submit a screenshot of your terminal showing the command you ran and the output that clearly identifies the discovered directories.'
...
```text
I completed the referenced lab for "Digital-Spelunking" and captured the requested evidence.
```
