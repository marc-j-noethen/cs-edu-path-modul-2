...
**Goal:**  
To practice using `msfconsole` to find and get detailed information about Metasploit modules related to specific vulnerabilities or tasks.

(It is assumed you have a local Kali Linux VM installed and running for this exercise, instructions in pre-class).

**Requirements:**

- Launch your local Kali Linux VM, open a terminal, and start `msfconsole`.
    
- **Scenario 1:** You've heard about a critical vulnerability in Apache Struts identified by the CVE ID "CVE-2017-5638".
    
- Use the `search` command to find exploit modules related to this CVE.
    
- Identify one relevant exploit module from the search results. Write down its full path.
...
objective = 'To practice using `msfconsole` to find and get detailed information about Metasploit modules related to specific vulnerabilities or tasks.
...
```text
I answered the required sub-tasks for "Module Pokedex" and submitted the requested format.
```
