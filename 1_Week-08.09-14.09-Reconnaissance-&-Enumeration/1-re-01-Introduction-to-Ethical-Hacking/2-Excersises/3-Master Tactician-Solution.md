...
**Course:** Cyber Security Analyst - Ethical Hacking | **Date:** 08 September 2025
...
**Goal:**  
Familiarize oneself with the range of MITRE ATT&CK® Enterprise Tactics, identify areas of unfamiliarity, and research one unknown tactic.

**Requirements:**

- Navigate to the official MITRE ATT&CK® website page for Enterprise Tactics: [https://attack.mitre.org/tactics/enterprise/](https://attack.mitre.org/tactics/enterprise/)
    
- Review the list of Enterprise Tactics displayed (e.g., Reconnaissance, Initial Access, Execution, Persistence, etc.). These are the high-level goals of an adversary.
    
- Based on your current understanding (from pre-class materials, the lesson, or general knowledge):
    
- Create **List A**: Write down the names of 3 Tactics whose general purpose you feel you already understand reasonably well.
...
objective = 'Familiarize oneself with the range of MITRE ATT&CK® Enterprise Tactics, identify areas of unfamiliarity, and research one unknown tactic.'
evidence = 'Your "List A" (names of Tactics you feel you understand).'
...
```text
I answered the required sub-tasks for "Master Tactician" and submitted the requested format.
```
