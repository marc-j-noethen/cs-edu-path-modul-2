...
**Goal:**  
Write a simple webpage that uses the WebAuthn API to demonstrate FIDO2's origin-binding security. You will first make it work correctly and then simulate a phishing attack to watch it fail.
...
objective = 'Write a simple webpage that uses the WebAuthn API to demonstrate FIDO2's origin-binding security. You will first make it work correctly and then simulate a phishing attack to watch it fail.'
evidence = 'Submit your complete HTML file containing your JavaScript implementation.'
...
```text
I answered the required sub-tasks for "Kingphisher" and submitted the requested format.
```
