...
**Course:** Cyber Security Analyst - Phishing Attacks & Email Defenses | **Date:** 17 September 2025
...
**Goal:**  
Complete the entire process of acquiring, securing, and testing a domain to gain a practical, hands-on understanding of email security defenses.

**Requirements:**

- Open the referenced room or lab in the intended platform.
    
- Work through the task until the objective is fully completed.
    
- Validate the final success state before submission.
    
- Capture the exact evidence requested by the exercise.
...
objective = 'Complete the entire process of acquiring, securing, and testing a domain to gain a practical, hands-on understanding of email security defenses.'
evidence = 'Submit a PDF report containing:'
...
```text
I completed the referenced lab for "Domain Expert" and captured the requested evidence.
```
