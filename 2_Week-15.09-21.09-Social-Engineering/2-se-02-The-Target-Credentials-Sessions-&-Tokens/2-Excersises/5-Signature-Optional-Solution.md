...
**Goal:**  
Complete the PortSwigger lab that exploits a JWT vulnerability.
...
objective = 'Complete the PortSwigger lab that exploits a JWT vulnerability.'
evidence = 'Submit a screenshot of the solved lab.'
...
```text
I completed the referenced lab for "Signature-Optional" and captured the requested evidence.
```
