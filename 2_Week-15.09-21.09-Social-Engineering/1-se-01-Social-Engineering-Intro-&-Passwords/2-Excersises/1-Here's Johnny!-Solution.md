...
**Goal:**  
Perform a basic dictionary attack using John the Ripper to crack a set of simple password hashes.
...
objective = 'Perform a basic dictionary attack using John the Ripper to crack a set of simple password hashes.'
evidence = 'Submit a single screenshot showing the command you used to run `john` and the output showing the cracked passwords.'
...
```text
I answered the required sub-tasks for "Here's Johnny!" and submitted the requested format.
```
