...
**Goal:**  
Research the purpose and format of the Linux `/etc/shadow` file and then use a standard cracking tool to crack a salted password from it.
...
objective = 'Research the purpose and format of the Linux `/etc/shadow` file and then use a standard cracking tool to crack a salted password from it.'
evidence = 'Submit your answers to the three research questions from Part 1, and a screenshot of the command you used in Part 2 showing the cracked password for the user `victim`.'
...
```text
I answered the required sub-tasks for "Shadowing Salt Bae" and submitted the requested format.
```
