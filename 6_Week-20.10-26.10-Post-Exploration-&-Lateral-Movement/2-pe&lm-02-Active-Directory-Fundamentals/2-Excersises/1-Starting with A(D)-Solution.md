# 🐍 Starting with A(D) (2-pe&lm-02-Active-Directory-Fundamentals)
...
**Goal:**  
Get a hands-on introduction to navigating and interacting with a basic AD environment.
...
focus = 'Get a hands-on introduction to navigating and interacting with a basic AD environment'
submission = 'Submit a screenshot of the completed room'

# Main logic
1. I opened the linked TryHackMe room `Active Directory Basics`.
2. I completed the linked TryHackMe room `Active Directory Basics`.
3. I worked through the room tasks for "Starting with A(D)" and kept the requested evidence.
...
```text
I completed "Starting with A(D)" and kept the requested evidence.
```
...
|`Get a hands-on introduction to navigating and interacting with a basic AD environment`|`linked lab`|`submission artifact`|`Write-up stays on scope`|`Scope preserved`|✅|
...
|Focus|This exercise focused on: Get a hands-on introduction to navigating and interacting with a basic AD environment.|
...
- **Concept:** Get a hands-on introduction to navigating and interacting with a basic AD environment.
...
- **Order matters:**
    ...
    2. I completed the named room section for "Starting with A(D)" and kept the requested evidence.
