...
**Course:** Cyber Security Analyst - Network Forensics | **Date:** 13 November 2025
...
**Goal:**  
Apply your analysis methodology to a wide variety of real-world malware captures and practice writing concise investigative reports. This is as real as it gets.

**Requirements:**

- Navigate to the Malware Traffic Analysis training page: [https://www.malware-traffic-analysis.net/training-exercises.html](https://www.malware-traffic-analysis.net/training-exercises.html)
    
- This page contains dozens of real-world infection scenarios.
    
- Starting from the latest exercise - read the scenario, download the PCAP (password is always `infected`), and begin your investigation.
    
- Each exercise has questions for you to answer.
...
objective = 'Apply your analysis methodology to a wide variety of real-world malware captures and practice writing concise investigative reports. This is as real as it gets.'
evidence = 'Submit your answers to the first exercise you solve. For later exercises, attach the answers in the comments to your submissions.'
...
```text
I answered the required sub-tasks for "Real Shark" and submitted the requested format.
```
