...
**Goal:**  
Complete the "Stored XSS into HTML context with nothing encoded" lab on PortSwigger's Web Security Academy.
...
objective = 'Complete the "Stored XSS into HTML context with nothing encoded" lab on PortSwigger's Web Security Academy.'
...
```text
I completed the referenced lab for "Digital-Graffiti" and captured the requested evidence.
```
