...
**Course:** Cyber Security Analyst - Cross Site Scripting | **Date:** 24 September 2025
...
**Goal:**  
Complete the "Reflected XSS into HTML context with nothing encoded" lab on PortSwigger's Web Security Academy.
...
objective = 'Complete the "Reflected XSS into HTML context with nothing encoded" lab on PortSwigger's Web Security Academy.'
evidence = 'Submit a screenshot of the completed lab.'
...
```text
I completed the referenced lab for "Return-to-Sender" and captured the requested evidence.
```
