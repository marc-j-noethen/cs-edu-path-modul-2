...
**Course:** Cyber Security Analyst - SQL Injection| **Date:** 23 September 2025
...
**Goal:**  
Use a classic SQL injection payload to bypass the login functionality of a web application.
...
objective = 'Use a classic SQL injection payload to bypass the login functionality of a web application.'
evidence = 'Submit a screenshot of the complete lab'
...
```text
I completed the referenced lab for "Login" and captured the requested evidence.
```
