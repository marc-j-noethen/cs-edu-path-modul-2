...
**Goal:**  
Use a UNION-based SQL injection attack to retrieve data from other tables in the database.
...
objective = 'Use a UNION-based SQL injection attack to retrieve data from other tables in the database.'
evidence = 'Screenshot of the complete lab'
...
```text
I completed the referenced lab for "Spilling the Tea" and captured the requested evidence.
```
