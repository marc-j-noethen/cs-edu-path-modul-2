# 🐍 The Forgetful Password 

**Course:** Cyber Security Analyst - Broken Authentication & Access-Control | **Date:** 25 September 2025
...
**Goal:**  
Exploit a flawed password reset mechanism to gain access to another user's account.
...
objective = 'Exploit a flawed password reset mechanism to gain access to another user's account.'
...
```text
I completed the referenced lab for "The Forgetful Password" and captured the requested evidence.
```
