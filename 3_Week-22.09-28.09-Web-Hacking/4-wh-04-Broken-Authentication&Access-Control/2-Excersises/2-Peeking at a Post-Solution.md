...
**Goal:**  
Exploit an IDOR vulnerability to view content belonging to another user.
...
objective = 'Exploit an IDOR vulnerability to view content belonging to another user.'
...
```text
I completed the referenced lab for "Peeking at a Post" and captured the requested evidence.
```
