...
**Goal:**  
Practice bypassing access control based on the referrer header
...
objective = 'Practice bypassing access control based on the referrer header'
...
```text
I completed the referenced lab for "My Admin Friend" and captured the requested evidence.
```
