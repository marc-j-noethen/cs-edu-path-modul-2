...
**Goal:**  
Overcome the insecure “double submit” CSRF prevention technique
...
objective = 'Overcome the insecure “double submit” CSRF prevention technique'
...
```text
I completed the referenced lab for "Cross the Bakery" and captured the requested evidence.
```
