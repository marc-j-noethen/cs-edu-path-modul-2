...
**Goal:**  
Use Burp Repeater to manually manipulate an HTTP request and discover information that isn't accessible through the normal user interface.
...
objective = 'Use Burp Repeater to manually manipulate an HTTP request and discover information that isn't accessible through the normal user interface.'
evidence = 'Submit screenshot of the completed lab'
...
```text
I completed the referenced lab for "Repeat-Offender" and captured the requested evidence.
```
